...
function Carrossel2() {
  ...
  return (
    <div>
      <Carousel variant="dark" fade controls keyboard={true} interval={null} pause="hover" slide={true} style={{ borderRadius: 4, width: 700, height: 570, display:'flex', alignItems:'center', backgroundColor: '#E2E3FF'}}>
